...
#
# Generated by export_simulation on Fri Nov 25 12:51:40 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './MicroBlazeDemo1.sh' script.

./MicroBlazeDemo1.sh -reset_run
...
./MicroBlazeDemo1.sh -noclean_files

For more information on the script, please type './MicroBlazeDemo1.sh -help'.
