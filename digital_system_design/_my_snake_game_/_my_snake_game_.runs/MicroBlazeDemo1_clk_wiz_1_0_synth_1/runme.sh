...
HD_PWD='E:/FPGA/digital_system_design/_my_snake_game_/_my_snake_game_.runs/MicroBlazeDemo1_clk_wiz_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MicroBlazeDemo1_clk_wiz_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MicroBlazeDemo1_clk_wiz_1_0.tcl
