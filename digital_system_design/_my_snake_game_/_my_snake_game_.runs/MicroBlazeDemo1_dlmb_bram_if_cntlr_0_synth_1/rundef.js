...
ISEStep( "vivado",
         "-log MicroBlazeDemo1_dlmb_bram_if_cntlr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MicroBlazeDemo1_dlmb_bram_if_cntlr_0.tcl" );
