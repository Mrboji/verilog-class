...
HD_PWD='E:/FPGA/digital_system_design/MicroBlaze_custom_ip/MicroBlaze_custom_ip.runs/MicroBlazeDemo1_dlmb_bram_if_cntlr_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MicroBlazeDemo1_dlmb_bram_if_cntlr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MicroBlazeDemo1_dlmb_bram_if_cntlr_0.tcl
