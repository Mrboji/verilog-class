...
HD_PWD='E:/FPGA/digital_system_design/MicroBlaze_custom_ip/MicroBlaze_custom_ip.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MicroBlazeDemo1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MicroBlazeDemo1_wrapper.tcl -notrace
