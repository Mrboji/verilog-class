...
HD_PWD='e:/fpga/digital_system_design/microblaze_custom_ip/microblaze_custom_ip.tmp/my_pwm_ip_v1_0_project/my_pwm_ip_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_pwm_ip_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_pwm_ip_v1_0.tcl
