...
HD_PWD='E:/FPGA/digital_system_design/MicroBlaze_int/MicroBlaze_intr/MicroBlaze_intr.runs/MicroBlazeDemo1_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MicroBlazeDemo1_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MicroBlazeDemo1_xbar_0.tcl
